...
export const metadata: Metadata = {
  title: "Money Transfer — Atlantic Xchange",
  description:
    "Send money internationally from the USA with competitive rates, zero hidden fees, and fast delivery. Personal or business transfers to 150+ countries.",
};

const benefits = [
  {
    title: "Competitive exchange rates",
    desc: "We work with real mid-market rates and a thin, transparent spread — so more of your money reaches the recipient.",
    color: "bg-navy-800",
    icon: (
  ...
  },
  {
    ...
    desc: "The fee you see before you send is the only fee you pay. No intermediary surprises, no end-of-transfer deductions.",
    color: "bg-teal-600",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  },
  {
    ...
    desc: "Most transfers are completed within 24 hours. Key corridors — including Jordan, Egypt, and UAE — are often same-day.",
...
const transferTypes = [
  {
    ...
    details: [
      ...
      "Most transfers processed within 24 hours",
  ...
  },
  {
    ...
    desc: "Send to Jordan, Egypt, UAE, Syria, Iraq, and across the region — cash pickup or bank transfer, often the same day.",
    details: [
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          subtitle="Personal or business transfers to 150+ countries. Competitive exchange rates, a flat transparent fee, and reliable delivery — all from one trusted platform."
          accentColor="green"
        />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
            <Reveal variant="fade-up" duration={700}>
              <div className="text-center mb-12 sm:mb-16">
                <p className="text-teal-600 text-xs font-bold uppercase tracking-[0.15em] mb-4">Transfer Options</p>
                <h2 className="font-heading font-extrabold text-navy-800 text-3xl sm:text-4xl lg:text-5xl mb-4">
                  Who Are You Sending For?
                </h2>
                <p className="text-gray-500 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
                  Whether you&apos;re supporting family abroad or paying international suppliers, we have the right solution.
                </p>
              </div>
            </Reveal>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
              {transferTypes.map((svc, i) => (
                <Reveal key={svc.id} variant="fade-up" delay={i * 100} duration={700}>
                  <div id={svc.id} className={`group scroll-mt-24 bg-white rounded-2xl border ${svc.border} p-7 sm:p-9 transition-all duration-200 h-full flex flex-col`}>
                    ...
                    <h3 className="font-heading font-bold text-navy-800 text-xl sm:text-2xl mb-3">{svc.title}</h3>
          ...
          <Reveal variant="fade-up" duration={700}>
            <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
              ...
              <p className="text-white/55 text-base sm:text-lg mb-8 leading-relaxed">
                Start a transfer online, use the app, or visit any Atlantic Xchange location.
              </p>
